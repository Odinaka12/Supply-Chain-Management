...
export default ({ startModal, setStartModal, startShipment, fetchData}) => {
                    ...
                    <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
                        ...
                        <form onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="relative mt-3">
                             ...
                             <button type="button" onClick={() => startShipping()} className="block w-full mt-3 py-3 px-4 font-medium text-sm text-center text-white bg-indigo-600 hover:bg-indigo-500  active:bg-indigo-700 rounded-lg ring-offset-2 ring-indigo-600 focus:ring-2">
                                Start Shipment
                            </button>
                        </form>
                    </div>
